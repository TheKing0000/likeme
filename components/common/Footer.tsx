  ...
  return (
    <>
      <footer className="w-full">
        ...
        <div className="pt-16 pb-12 text-sm   dark:bg-[#16161a]">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              ...
              >
                <h3
                  className="mb-6 text-base font-medium dark:text-[#FBFBFB]"
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <a
                      href="/"
                      className="transition-colors duration-300 hover:text-[#3da9fc] "
                    >
                      Features
                    </a>
                  </li>
        ...
        {/*      <!-- Sub Footer --> */}
        <div className="py-4 text-sm  dark:bg-[#16161a]">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              <div className="col-span-2 md:col-span-4 lg:col-span-6">
                Copyright 2023 LikeMe
              </div>
              <nav
